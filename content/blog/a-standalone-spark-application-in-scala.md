...
description: Learn how to create a standalone Spark application in Scala with the Simple Build Tool (SBT) and run it on Eclipse IDE. This tutorial covers building a Spark application to calculate popular hashtags over sliding windows from a Twitter stream & authenticating with Twitter credentials. Also, instructions for using the sbt eclipse plugin to run a sbt project in Eclipse included. Develop your own Spark application & improve your data engineering & analytics skills.
---
